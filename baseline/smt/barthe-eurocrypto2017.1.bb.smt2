...
(=>
(and (= c (gf2add (gf2mul a b) (gf2add call16.1.1 (gf2add (gf2mul a_1 b) (gf2add (gf2add (gf2mul a_1 b) call16.1183) (gf2mul a b_1))))))
(and (= c_1 (gf2add (gf2mul a_1 b_1) (gf2add call16.1183 (gf2add (gf2mul a b_1) (gf2add (gf2add (gf2mul a b_1) call16.1.1) (gf2mul a_1 b))))))
(and (= call (gf2add (gf2add call (gf2add a a_1)) call))
(and (= call1 (gf2add (gf2add call1 (gf2add b b_1)) call1))
(and (= call16.1183 call16.1183)
