...
(=>
(and (= c (gf2add (gf2mul a b) (gf2add (gf2mul (gf2add a #x01) call16) (gf2mul a (gf2add b_1 call16)))))
(and (= c_1 (gf2add (gf2mul a_1 b_1) (gf2add (gf2mul (gf2add a_1 #x01) call16) (gf2mul a_1 (gf2add b call16)))))
