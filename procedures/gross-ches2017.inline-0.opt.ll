; ModuleID = '../examples/gross-ches2017.inline-0.ll'
...
entry:
  ...
  %scevgep69 = getelementptr [1 x [1 x i8]], [1 x [1 x i8]]* %r, i64 0, i64 0, i64 0
  store i8 %call16, i8* %scevgep69, align 1
