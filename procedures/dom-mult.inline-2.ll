...
for.body15:                                       ; preds = %for.cond12
  ...
  %arrayidx26 = getelementptr inbounds [3 x [3 x i8]], [3 x [3 x i8]]* %r, i64 0, i64 %idxprom25
  %34 = load i32, i32* %j, align 4
  %idxprom27 = sext i32 %34 to i64
  %arrayidx28 = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx26, i64 0, i64 %idxprom27
  ...
  %arrayidx32 = getelementptr inbounds [3 x [3 x i8]], [3 x [3 x i8]]* %u, i64 0, i64 %idxprom31
  ...
  %arrayidx44 = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx42, i64 0, i64 %idxprom43
  ...
  %arrayidx49 = getelementptr inbounds [3 x [3 x i8]], [3 x [3 x i8]]* %u, i64 0, i64 %idxprom48
  %48 = load i32, i32* %i, align 4
  %idxprom50 = sext i32 %48 to i64
  %arrayidx51 = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx49, i64 0, i64 %idxprom50
...
if.then:                                          ; preds = %for.body71
  ...
  %arrayidx75 = getelementptr inbounds [3 x [3 x i8]], [3 x [3 x i8]]* %u, i64 0, i64 %idxprom74
  %64 = load i32, i32* %j67, align 4
  %idxprom76 = sext i32 %64 to i64
  %arrayidx77 = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx75, i64 0, i64 %idxprom76
