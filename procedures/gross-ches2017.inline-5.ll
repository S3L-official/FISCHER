...
for.body26:                                       ; preds = %for.cond23
  ...
  %arraydecay = getelementptr inbounds [6 x i8], [6 x i8]* %ab1, i64 0, i64 0
...
for.body.i108:                                    ; preds = %for.cond.i96
  ...
  %rem2.i102 = srem i32 %add1.i101, 6
...
vmult.exit110:                                    ; preds = %for.cond.i96
  ...
  %arraydecay29 = getelementptr inbounds [6 x i8], [6 x i8]* %a1b, i64 0, i64 0
...
for.body.i130:                                    ; preds = %for.cond.i118
  ...
  %rem2.i124 = srem i32 %add1.i123, 6
...
vmult.exit132:                                    ; preds = %for.cond.i118
  ...
  %arraydecay32 = getelementptr inbounds [6 x i8], [6 x i8]* %ab2, i64 0, i64 0
...
for.body.i152:                                    ; preds = %for.cond.i140
  ...
  %rem2.i146 = srem i32 %add1.i145, 6
...
vmult.exit154:                                    ; preds = %for.cond.i140
  ...
  %arraydecay35 = getelementptr inbounds [6 x i8], [6 x i8]* %a2b, i64 0, i64 0
...
for.body.i174:                                    ; preds = %for.cond.i162
  ...
  %rem2.i168 = srem i32 %add1.i167, 6
...
vmult.exit176:                                    ; preds = %for.cond.i162
  ...
  %arrayidx37 = getelementptr inbounds [6 x [6 x i8]], [6 x [6 x i8]]* %r, i64 0, i64 %idxprom36
  %arraydecay38 = getelementptr inbounds [6 x i8], [6 x i8]* %arrayidx37, i64 0, i64 0
...
for.body.i193:                                    ; preds = %for.cond.i184
  ...
  %rem2.i190 = srem i32 %add1.i189, 6
...
vadd.exit:                                        ; preds = %for.cond.i184
  ...
  %arraydecay39 = getelementptr inbounds [6 x i8], [6 x i8]* %ab1, i64 0, i64 0
...
for.body.i234:                                    ; preds = %for.cond.i219
  ...
  %rem2.i226 = srem i32 %add1.i225, 6
...
vadd.exit236:                                     ; preds = %for.cond.i219
  ...
  %arraydecay40 = getelementptr inbounds [6 x i8], [6 x i8]* %a1b, i64 0, i64 0
...
for.body.i331:                                    ; preds = %for.cond.i316
  ...
  %rem2.i323 = srem i32 %add1.i322, 6
...
vadd.exit333:                                     ; preds = %for.cond.i316
  ...
  %arrayidx42 = getelementptr inbounds [6 x [6 x i8]], [6 x [6 x i8]]* %r, i64 0, i64 %idxprom41
...
vadd.exit408:                                     ; preds = %for.cond.i391
  ...
  %arraydecay44 = getelementptr inbounds [6 x i8], [6 x i8]* %ab2, i64 0, i64 0
...
vadd.exit383:                                     ; preds = %for.cond.i366
  ...
  %arraydecay45 = getelementptr inbounds [6 x i8], [6 x i8]* %a2b, i64 0, i64 0
...
for.body.i356:                                    ; preds = %for.cond.i341
  ...
  %rem2.i348 = srem i32 %add1.i347, 6
...
for.body53:                                       ; preds = %for.cond50
  ...
  %arrayidx56 = getelementptr inbounds [6 x i8], [6 x i8]* %arrayidx54, i64 0, i64 %idxprom55
  %193 = load i8, i8* %arrayidx56, align 1
  %194 = load i32, i32* %i49, align 4
  %idxprom57 = sext i32 %194 to i64
  %arrayidx58 = getelementptr inbounds [6 x i8], [6 x i8]* %z, i64 0, i64 %idxprom57
...
for.body.i306:                                    ; preds = %for.cond.i294
  ...
  %rem2.i300 = srem i32 %add1.i299, 6
...
vmult.exit308:                                    ; preds = %for.cond.i294
  ...
  %arraydecay63 = getelementptr inbounds [6 x i8], [6 x i8]* %z, i64 0, i64 0
...
for.body.i284:                                    ; preds = %for.cond.i269
  ...
  %rem2.i276 = srem i32 %add1.i275, 6
...
vadd.exit286:                                     ; preds = %for.cond.i269
  ...
  %arraydecay64 = getelementptr inbounds [6 x i8], [6 x i8]* %ab1, i64 0, i64 0
...
for.body.i259:                                    ; preds = %for.cond.i244
  ...
  %rem2.i251 = srem i32 %add1.i250, 6
