...
entry:
  ...
  %A = alloca i8, align 1
  %B = alloca i8, align 1
  %alpha = alloca [151 x [151 x i8]], align 16
  %t = alloca [151 x [151 x i8]], align 16
  %r = alloca [151 x [151 x i8]], align 16
  %rr = alloca [151 x i8], align 16
  %i = alloca i32, align 4
...
for.cond.i.i214:                                  ; preds = %for.body.i.i223, %xors.exit
  ...
  %cmp.i.i213 = icmp sle i32 %14, 150
...
for.body15:                                       ; preds = %for.cond12
  ...
  %arrayidx20 = getelementptr inbounds [151 x [151 x i8]], [151 x [151 x i8]]* %alpha, i64 0, i64 %idxprom19
  %31 = load i32, i32* %j, align 4
  %idxprom21 = sext i32 %31 to i64
  %arrayidx22 = getelementptr inbounds [151 x i8], [151 x i8]* %arrayidx20, i64 0, i64 %idxprom21
...
for.body36:                                       ; preds = %for.cond32
  ...
  %arrayidx39 = getelementptr inbounds [151 x [151 x i8]], [151 x [151 x i8]]* %r, i64 0, i64 %idxprom38
  %38 = load i32, i32* %j31, align 4
  %sub40 = sub nsw i32 150, %38
  %idxprom41 = sext i32 %sub40 to i64
  %arrayidx42 = getelementptr inbounds [151 x i8], [151 x i8]* %arrayidx39, i64 0, i64 %idxprom41
...
for.body52:                                       ; preds = %for.cond49
  ...
  %arrayidx55 = getelementptr inbounds [151 x i8], [151 x i8]* %rr, i64 0, i64 %idxprom54
...
for.cond60:                                       ; preds = %for.inc199, %for.end58
  ...
  %cmp61 = icmp sle i32 %44, 150
  br i1 %cmp61, label %for.body63, label %for.end201

for.body63:                                       ; preds = %for.cond60
  %45 = load i32, i32* %i59, align 4
  %idxprom64 = sext i32 %45 to i64
  %arrayidx65 = getelementptr inbounds [151 x [151 x i8]], [151 x [151 x i8]]* %alpha, i64 0, i64 %idxprom64
  %46 = load i32, i32* %i59, align 4
  %idxprom66 = sext i32 %46 to i64
  %arrayidx67 = getelementptr inbounds [151 x i8], [151 x i8]* %arrayidx65, i64 0, i64 %idxprom66
...
for.body75:                                       ; preds = %for.cond71
  ...
  %arrayidx77 = getelementptr inbounds [151 x [151 x i8]], [151 x [151 x i8]]* %r, i64 0, i64 %idxprom76
  %53 = load i32, i32* %j70, align 4
  %idxprom78 = sext i32 %53 to i64
  %arrayidx79 = getelementptr inbounds [151 x i8], [151 x i8]* %arrayidx77, i64 0, i64 %idxprom78
  %54 = load i8, i8* %arrayidx79, align 1
  %conv80 = zext i8 %54 to i32
  %55 = load i32, i32* %i59, align 4
  %idxprom81 = sext i32 %55 to i64
  %arrayidx82 = getelementptr inbounds [151 x [151 x i8]], [151 x [151 x i8]]* %alpha, i64 0, i64 %idxprom81
  %56 = load i32, i32* %j70, align 4
  %idxprom83 = sext i32 %56 to i64
  %arrayidx84 = getelementptr inbounds [151 x i8], [151 x i8]* %arrayidx82, i64 0, i64 %idxprom83
  ...
  %arrayidx87 = getelementptr inbounds [151 x [151 x i8]], [151 x [151 x i8]]* %alpha, i64 0, i64 %idxprom86
  %59 = load i32, i32* %i59, align 4
  %idxprom88 = sext i32 %59 to i64
  %arrayidx89 = getelementptr inbounds [151 x i8], [151 x i8]* %arrayidx87, i64 0, i64 %idxprom88
  ...
  %arrayidx94 = getelementptr inbounds [151 x i8], [151 x i8]* %rr, i64 0, i64 %idxprom93
  ...
  %arrayidx98 = getelementptr inbounds [151 x [151 x i8]], [151 x [151 x i8]]* %alpha, i64 0, i64 %idxprom97
  %64 = load i32, i32* %j70, align 4
  %sub99 = sub nsw i32 %64, 1
  %idxprom100 = sext i32 %sub99 to i64
  %arrayidx101 = getelementptr inbounds [151 x i8], [151 x i8]* %arrayidx98, i64 0, i64 %idxprom100
  ...
  %arrayidx106 = getelementptr inbounds [151 x [151 x i8]], [151 x [151 x i8]]* %alpha, i64 0, i64 %idxprom105
  %67 = load i32, i32* %i59, align 4
  %idxprom107 = sext i32 %67 to i64
  %arrayidx108 = getelementptr inbounds [151 x i8], [151 x i8]* %arrayidx106, i64 0, i64 %idxprom107
  ...
  %arrayidx113 = getelementptr inbounds [151 x [151 x i8]], [151 x [151 x i8]]* %t, i64 0, i64 %idxprom112
  %70 = load i32, i32* %j70, align 4
  %idxprom114 = sext i32 %70 to i64
  %arrayidx115 = getelementptr inbounds [151 x i8], [151 x i8]* %arrayidx113, i64 0, i64 %idxprom114
  store i8 %conv111, i8* %arrayidx115, align 1
  %71 = load i32, i32* %i59, align 4
  %idxprom116 = sext i32 %71 to i64
  %arrayidx117 = getelementptr inbounds [151 x [151 x i8]], [151 x [151 x i8]]* %t, i64 0, i64 %idxprom116
  %72 = load i32, i32* %j70, align 4
  %idxprom118 = sext i32 %72 to i64
  %arrayidx119 = getelementptr inbounds [151 x i8], [151 x i8]* %arrayidx117, i64 0, i64 %idxprom118
...
if.then:                                          ; preds = %for.end128
  ...
  %arrayidx132 = getelementptr inbounds [151 x [151 x i8]], [151 x [151 x i8]]* %r, i64 0, i64 %idxprom131
  %80 = load i32, i32* %i59, align 4
  %add133 = add nsw i32 %80, 1
  %idxprom134 = sext i32 %add133 to i64
  %arrayidx135 = getelementptr inbounds [151 x i8], [151 x i8]* %arrayidx132, i64 0, i64 %idxprom134
  %81 = load i8, i8* %arrayidx135, align 1
  %conv136 = zext i8 %81 to i32
  %82 = load i32, i32* %i59, align 4
  %idxprom137 = sext i32 %82 to i64
  %arrayidx138 = getelementptr inbounds [151 x [151 x i8]], [151 x [151 x i8]]* %alpha, i64 0, i64 %idxprom137
  %83 = load i32, i32* %i59, align 4
  %add139 = add nsw i32 %83, 1
  %idxprom140 = sext i32 %add139 to i64
  %arrayidx141 = getelementptr inbounds [151 x i8], [151 x i8]* %arrayidx138, i64 0, i64 %idxprom140
  ...
  %arrayidx146 = getelementptr inbounds [151 x [151 x i8]], [151 x [151 x i8]]* %alpha, i64 0, i64 %idxprom145
  %86 = load i32, i32* %i59, align 4
  %idxprom147 = sext i32 %86 to i64
  %arrayidx148 = getelementptr inbounds [151 x i8], [151 x i8]* %arrayidx146, i64 0, i64 %idxprom147
  ...
  %arrayidx153 = getelementptr inbounds [151 x [151 x i8]], [151 x [151 x i8]]* %t, i64 0, i64 %idxprom152
  %89 = load i32, i32* %i59, align 4
  %add154 = add nsw i32 %89, 1
  %idxprom155 = sext i32 %add154 to i64
  %arrayidx156 = getelementptr inbounds [151 x i8], [151 x i8]* %arrayidx153, i64 0, i64 %idxprom155
  store i8 %conv151, i8* %arrayidx156, align 1
  %90 = load i32, i32* %i59, align 4
  %idxprom157 = sext i32 %90 to i64
  %arrayidx158 = getelementptr inbounds [151 x [151 x i8]], [151 x [151 x i8]]* %t, i64 0, i64 %idxprom157
  %91 = load i32, i32* %i59, align 4
  %add159 = add nsw i32 %91, 1
  %idxprom160 = sext i32 %add159 to i64
  %arrayidx161 = getelementptr inbounds [151 x i8], [151 x i8]* %arrayidx158, i64 0, i64 %idxprom160
...
if.then171:                                       ; preds = %if.then
  ...
  %arrayidx173 = getelementptr inbounds [151 x i8], [151 x i8]* %rr, i64 0, i64 %idxprom172
...
for.body185:                                      ; preds = %for.cond182
  ...
  %arrayidx187 = getelementptr inbounds [151 x [151 x i8]], [151 x [151 x i8]]* %r, i64 0, i64 %idxprom186
  %105 = load i32, i32* %i59, align 4
  %idxprom188 = sext i32 %105 to i64
  %arrayidx189 = getelementptr inbounds [151 x i8], [151 x i8]* %arrayidx187, i64 0, i64 %idxprom188
...
for.cond.i.i231:                                  ; preds = %for.body.i.i240, %for.end201
  ...
  %cmp.i.i230 = icmp sle i32 %116, 150
