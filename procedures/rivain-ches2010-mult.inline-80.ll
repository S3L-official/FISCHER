...
if.then:                                          ; preds = %for.body61
  ...
  %arrayidx65 = getelementptr inbounds [81 x [81 x i8]], [81 x [81 x i8]]* %r, i64 0, i64 %idxprom64
