...
vmult.exit94:                                     ; preds = %for.cond.i80
  ...
  %arraydecay29 = getelementptr inbounds [5 x i8], [5 x i8]* %a1b, i64 0, i64 0
...
for.body.i114:                                    ; preds = %for.cond.i102
  ...
  %rem2.i108 = srem i32 %add1.i107, 5
...
vmult.exit116:                                    ; preds = %for.cond.i102
  ...
  %arraydecay32 = getelementptr inbounds [5 x i8], [5 x i8]* %ab2, i64 0, i64 0
...
for.body.i136:                                    ; preds = %for.cond.i124
  ...
  %rem2.i130 = srem i32 %add1.i129, 5
...
vmult.exit138:                                    ; preds = %for.cond.i124
  ...
  %arraydecay35 = getelementptr inbounds [5 x i8], [5 x i8]* %a2b, i64 0, i64 0
...
for.body.i158:                                    ; preds = %for.cond.i146
  ...
  %rem2.i152 = srem i32 %add1.i151, 5
...
vmult.exit160:                                    ; preds = %for.cond.i146
  ...
  %arrayidx37 = getelementptr inbounds [5 x [5 x i8]], [5 x [5 x i8]]* %r, i64 0, i64 %idxprom36
  %arraydecay38 = getelementptr inbounds [5 x i8], [5 x i8]* %arrayidx37, i64 0, i64 0
...
for.body.i177:                                    ; preds = %for.cond.i168
  ...
  %rem2.i174 = srem i32 %add1.i173, 5
...
vadd.exit:                                        ; preds = %for.cond.i168
  ...
  %arraydecay39 = getelementptr inbounds [5 x i8], [5 x i8]* %ab1, i64 0, i64 0
...
for.body.i218:                                    ; preds = %for.cond.i203
  ...
  %rem2.i210 = srem i32 %add1.i209, 5
...
vadd.exit220:                                     ; preds = %for.cond.i203
  ...
  %arraydecay40 = getelementptr inbounds [5 x i8], [5 x i8]* %a1b, i64 0, i64 0
...
for.body.i318:                                    ; preds = %for.cond.i303
  ...
  %rem2.i310 = srem i32 %add1.i309, 5
...
vadd.exit320:                                     ; preds = %for.cond.i303
  ...
  %arrayidx42 = getelementptr inbounds [5 x [5 x i8]], [5 x [5 x i8]]* %r, i64 0, i64 %idxprom41
...
for.body.i293:                                    ; preds = %for.cond.i278
  ...
  %rem2.i285 = srem i32 %add1.i284, 5
...
vadd.exit295:                                     ; preds = %for.cond.i278
  ...
  %arraydecay44 = getelementptr inbounds [5 x i8], [5 x i8]* %ab2, i64 0, i64 0
...
for.body.i268:                                    ; preds = %for.cond.i253
  ...
  %rem2.i260 = srem i32 %add1.i259, 5
...
vadd.exit270:                                     ; preds = %for.cond.i253
  ...
  %arraydecay45 = getelementptr inbounds [5 x i8], [5 x i8]* %a2b, i64 0, i64 0
...
for.body.i243:                                    ; preds = %for.cond.i228
  ...
  %rem2.i235 = srem i32 %add1.i234, 5
