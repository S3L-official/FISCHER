...
for.cond.i.i109.i:                                ; preds = %for.body.i.i118.i, %for.end79.i
  ...
  %cmp.i.i108.i = icmp sle i32 %109, 2
...
for.cond.i.i.i113:                                ; preds = %for.body.i.i.i122, %sec_mult.exit
  ...
  %cmp.i.i.i112 = icmp sle i32 %121, 2
...
for.cond.i.i92.i128:                              ; preds = %for.body.i.i101.i137, %xors.exit.i126
  ...
  %cmp.i.i91.i127 = icmp sle i32 %132, 2
...
for.body15.i176:                                  ; preds = %for.cond12.i146
  ...
  %arrayidx.i149 = getelementptr inbounds [3 x [3 x i8]], [3 x [3 x i8]]* %r.i, i64 0, i64 %idxprom.i148
  %144 = load i32, i32* %j.i106, align 4
  %idxprom17.i150 = sext i32 %144 to i64
  %arrayidx18.i151 = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx.i149, i64 0, i64 %idxprom17.i150
  store i8 %call16.i147, i8* %arrayidx18.i151, align 1
  %145 = load i32, i32* %i.i105, align 4
  %idxprom19.i152 = sext i32 %145 to i64
  %arrayidx20.i153 = getelementptr inbounds [3 x [3 x i8]], [3 x [3 x i8]]* %r.i, i64 0, i64 %idxprom19.i152
  %146 = load i32, i32* %j.i106, align 4
  %idxprom21.i154 = sext i32 %146 to i64
  %arrayidx22.i155 = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx20.i153, i64 0, i64 %idxprom21.i154
  ...
  %arrayidx39.i173 = getelementptr inbounds [3 x [3 x i8]], [3 x [3 x i8]]* %r.i, i64 0, i64 %idxprom38.i172
  %161 = load i32, i32* %i.i105, align 4
  %idxprom40.i174 = sext i32 %161 to i64
  %arrayidx41.i175 = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx39.i173, i64 0, i64 %idxprom40.i174
...
if.then.i205:                                     ; preds = %for.body61.i194
  ...
  %arrayidx65.i196 = getelementptr inbounds [3 x [3 x i8]], [3 x [3 x i8]]* %r.i, i64 0, i64 %idxprom64.i195
  %177 = load i32, i32* %j57.i108, align 4
  %idxprom66.i197 = sext i32 %177 to i64
  %arrayidx67.i198 = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx65.i196, i64 0, i64 %idxprom66.i197
...
for.cond.i.i109.i214:                             ; preds = %for.body.i.i118.i223, %for.end79.i212
  ...
  %cmp.i.i108.i213 = icmp sle i32 %188, 2
...
for.cond.i.i.i256:                                ; preds = %for.body.i.i.i265, %sec_mult.exit226
  ...
  %cmp.i.i.i255 = icmp sle i32 %199, 2
...
for.cond.i.i92.i271:                              ; preds = %for.body.i.i101.i280, %xors.exit.i269
  ...
  %cmp.i.i91.i270 = icmp sle i32 %210, 2
...
for.body15.i319:                                  ; preds = %for.cond12.i289
  ...
  %arrayidx.i292 = getelementptr inbounds [3 x [3 x i8]], [3 x [3 x i8]]* %r.i, i64 0, i64 %idxprom.i291
  %222 = load i32, i32* %j.i249, align 4
  %idxprom17.i293 = sext i32 %222 to i64
  %arrayidx18.i294 = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx.i292, i64 0, i64 %idxprom17.i293
  store i8 %call16.i290, i8* %arrayidx18.i294, align 1
  %223 = load i32, i32* %i.i248, align 4
  %idxprom19.i295 = sext i32 %223 to i64
  %arrayidx20.i296 = getelementptr inbounds [3 x [3 x i8]], [3 x [3 x i8]]* %r.i, i64 0, i64 %idxprom19.i295
  %224 = load i32, i32* %j.i249, align 4
  %idxprom21.i297 = sext i32 %224 to i64
  %arrayidx22.i298 = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx20.i296, i64 0, i64 %idxprom21.i297
  ...
  %arrayidx39.i316 = getelementptr inbounds [3 x [3 x i8]], [3 x [3 x i8]]* %r.i, i64 0, i64 %idxprom38.i315
  %239 = load i32, i32* %i.i248, align 4
  %idxprom40.i317 = sext i32 %239 to i64
  %arrayidx41.i318 = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx39.i316, i64 0, i64 %idxprom40.i317
...
if.then.i348:                                     ; preds = %for.body61.i337
  ...
  %arrayidx65.i339 = getelementptr inbounds [3 x [3 x i8]], [3 x [3 x i8]]* %r.i, i64 0, i64 %idxprom64.i338
  %255 = load i32, i32* %j57.i251, align 4
  %idxprom66.i340 = sext i32 %255 to i64
  %arrayidx67.i341 = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx65.i339, i64 0, i64 %idxprom66.i340
...
for.cond.i.i109.i357:                             ; preds = %for.body.i.i118.i366, %for.end79.i355
  ...
  %cmp.i.i108.i356 = icmp sle i32 %266, 2
