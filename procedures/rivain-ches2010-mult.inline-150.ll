...
for.body15:                                       ; preds = %for.cond12
  ...
  %arrayidx41 = getelementptr inbounds [151 x i8], [151 x i8]* %arrayidx39, i64 0, i64 %idxprom40
...
if.then:                                          ; preds = %for.body61
  ...
  %arrayidx65 = getelementptr inbounds [151 x [151 x i8]], [151 x [151 x i8]]* %r, i64 0, i64 %idxprom64
...
for.cond.i.i109:                                  ; preds = %for.body.i.i118, %for.end79
  ...
  %cmp.i.i108 = icmp sle i32 %70, 150
