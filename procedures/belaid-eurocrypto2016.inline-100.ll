...
entry:
  ...
  %A = alloca i8, align 1
  %B = alloca i8, align 1
  %alpha = alloca [101 x [101 x i8]], align 16
  %t = alloca [101 x [101 x i8]], align 16
  %r = alloca [101 x [101 x i8]], align 16
  %rr = alloca [101 x i8], align 16
  %i = alloca i32, align 4
...
for.cond.i.i214:                                  ; preds = %for.body.i.i223, %xors.exit
  ...
  %cmp.i.i213 = icmp sle i32 %14, 100
...
for.body15:                                       ; preds = %for.cond12
  ...
  %arrayidx20 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* %alpha, i64 0, i64 %idxprom19
...
for.body36:                                       ; preds = %for.cond32
  ...
  %arrayidx39 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* %r, i64 0, i64 %idxprom38
  %38 = load i32, i32* %j31, align 4
  %sub40 = sub nsw i32 100, %38
...
for.body52:                                       ; preds = %for.cond49
  ...
  %arrayidx55 = getelementptr inbounds [101 x i8], [101 x i8]* %rr, i64 0, i64 %idxprom54
...
for.cond60:                                       ; preds = %for.inc199, %for.end58
  ...
  %cmp61 = icmp sle i32 %44, 100
  br i1 %cmp61, label %for.body63, label %for.end201

for.body63:                                       ; preds = %for.cond60
  %45 = load i32, i32* %i59, align 4
  %idxprom64 = sext i32 %45 to i64
  %arrayidx65 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* %alpha, i64 0, i64 %idxprom64
...
for.body75:                                       ; preds = %for.cond71
  ...
  %arrayidx82 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* %alpha, i64 0, i64 %idxprom81
  ...
  %arrayidx87 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* %alpha, i64 0, i64 %idxprom86
  ...
  %arrayidx94 = getelementptr inbounds [101 x i8], [101 x i8]* %rr, i64 0, i64 %idxprom93
  ...
  %arrayidx98 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* %alpha, i64 0, i64 %idxprom97
  ...
  %arrayidx106 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* %alpha, i64 0, i64 %idxprom105
  ...
  %arrayidx113 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* %t, i64 0, i64 %idxprom112
  %70 = load i32, i32* %j70, align 4
  %idxprom114 = sext i32 %70 to i64
  %arrayidx115 = getelementptr inbounds [101 x i8], [101 x i8]* %arrayidx113, i64 0, i64 %idxprom114
  store i8 %conv111, i8* %arrayidx115, align 1
  %71 = load i32, i32* %i59, align 4
  %idxprom116 = sext i32 %71 to i64
  %arrayidx117 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* %t, i64 0, i64 %idxprom116
...
if.then:                                          ; preds = %for.end128
  ...
  %arrayidx132 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* %r, i64 0, i64 %idxprom131
  ...
  %arrayidx138 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* %alpha, i64 0, i64 %idxprom137
  %83 = load i32, i32* %i59, align 4
  %add139 = add nsw i32 %83, 1
  %idxprom140 = sext i32 %add139 to i64
  %arrayidx141 = getelementptr inbounds [101 x i8], [101 x i8]* %arrayidx138, i64 0, i64 %idxprom140
  ...
  %arrayidx146 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* %alpha, i64 0, i64 %idxprom145
  ...
  %arrayidx153 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* %t, i64 0, i64 %idxprom152
  ...
  %arrayidx158 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* %t, i64 0, i64 %idxprom157
  %91 = load i32, i32* %i59, align 4
  %add159 = add nsw i32 %91, 1
  %idxprom160 = sext i32 %add159 to i64
  %arrayidx161 = getelementptr inbounds [101 x i8], [101 x i8]* %arrayidx158, i64 0, i64 %idxprom160
...
if.then171:                                       ; preds = %if.then
  ...
  %arrayidx173 = getelementptr inbounds [101 x i8], [101 x i8]* %rr, i64 0, i64 %idxprom172
...
for.body185:                                      ; preds = %for.cond182
  ...
  %arrayidx187 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* %r, i64 0, i64 %idxprom186
...
for.cond.i.i231:                                  ; preds = %for.body.i.i240, %for.end201
  ...
  %cmp.i.i230 = icmp sle i32 %116, 100
