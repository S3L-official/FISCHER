...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx12 = getelementptr inbounds [4 x [4 x i8]], [4 x [4 x i8]]* %r, i64 0, i64 %idxprom11
  %12 = load i32, i32* %j, align 4
  %idxprom13 = sext i32 %12 to i64
  %arrayidx14 = getelementptr inbounds [4 x i8], [4 x i8]* %arrayidx12, i64 0, i64 %idxprom13
  ...
  %arrayidx18 = getelementptr inbounds [4 x [4 x i8]], [4 x [4 x i8]]* %u, i64 0, i64 %idxprom17
  %15 = load i32, i32* %j, align 4
  %idxprom19 = sext i32 %15 to i64
  %arrayidx20 = getelementptr inbounds [4 x i8], [4 x i8]* %arrayidx18, i64 0, i64 %idxprom19
  ...
  %arrayidx28 = getelementptr inbounds [4 x [4 x i8]], [4 x [4 x i8]]* %r, i64 0, i64 %idxprom27
  ...
  %arrayidx35 = getelementptr inbounds [4 x [4 x i8]], [4 x [4 x i8]]* %u, i64 0, i64 %idxprom34
  %26 = load i32, i32* %i, align 4
  %idxprom36 = sext i32 %26 to i64
  %arrayidx37 = getelementptr inbounds [4 x i8], [4 x i8]* %arrayidx35, i64 0, i64 %idxprom36
...
if.then:                                          ; preds = %for.body57
  ...
  %arrayidx61 = getelementptr inbounds [4 x [4 x i8]], [4 x [4 x i8]]* %u, i64 0, i64 %idxprom60
...
xors.exit33:                                      ; preds = %for.cond.i.i23
  ...
  %arraydecay = getelementptr inbounds [4 x i8], [4 x i8]* %br, i64 0, i64 0
...
for.cond9.i:                                      ; preds = %for.body13.i, %for.body.i39
  ...
  %cmp11.i = icmp sle i32 %conv10.i, 3
...
for.body3.i:                                      ; preds = %for.cond1.i
  ...
  %arrayidx.i52 = getelementptr inbounds [4 x [4 x i8]], [4 x [4 x i8]]* %r.i, i64 0, i64 %idxprom.i51
  %73 = load i32, i32* %j.i45, align 4
  %idxprom4.i = sext i32 %73 to i64
  %arrayidx5.i = getelementptr inbounds [4 x i8], [4 x i8]* %arrayidx.i52, i64 0, i64 %idxprom4.i
  ...
  %arrayidx12.i = getelementptr inbounds [4 x [4 x i8]], [4 x [4 x i8]]* %r.i, i64 0, i64 %idxprom11.i
  %81 = load i32, i32* %j.i45, align 4
  %idxprom13.i = sext i32 %81 to i64
  %arrayidx14.i = getelementptr inbounds [4 x i8], [4 x i8]* %arrayidx12.i, i64 0, i64 %idxprom13.i
  ...
  %arrayidx18.i = getelementptr inbounds [4 x [4 x i8]], [4 x [4 x i8]]* %u.i, i64 0, i64 %idxprom17.i
  %84 = load i32, i32* %j.i45, align 4
  %idxprom19.i57 = sext i32 %84 to i64
  %arrayidx20.i58 = getelementptr inbounds [4 x i8], [4 x i8]* %arrayidx18.i, i64 0, i64 %idxprom19.i57
  ...
  %arrayidx28.i = getelementptr inbounds [4 x [4 x i8]], [4 x [4 x i8]]* %r.i, i64 0, i64 %idxprom27.i
  %92 = load i32, i32* %j.i45, align 4
  %idxprom29.i = sext i32 %92 to i64
  %arrayidx30.i = getelementptr inbounds [4 x i8], [4 x i8]* %arrayidx28.i, i64 0, i64 %idxprom29.i
  ...
  %arrayidx35.i = getelementptr inbounds [4 x [4 x i8]], [4 x [4 x i8]]* %u.i, i64 0, i64 %idxprom34.i
  %95 = load i32, i32* %i.i44, align 4
  %idxprom36.i = sext i32 %95 to i64
  %arrayidx37.i = getelementptr inbounds [4 x i8], [4 x i8]* %arrayidx35.i, i64 0, i64 %idxprom36.i
...
if.then.i:                                        ; preds = %for.body57.i
  ...
  %arrayidx61.i = getelementptr inbounds [4 x [4 x i8]], [4 x [4 x i8]]* %u.i, i64 0, i64 %idxprom60.i
