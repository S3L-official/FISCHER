...
entry:
  ...
  %s = alloca [81 x [81 x i8]], align 16
  %p0 = alloca [81 x [81 x i8]], align 16
  %p1 = alloca [81 x [81 x i8]], align 16
  %z = alloca [81 x [81 x i8]], align 16
  %i = alloca i32, align 4
...
for.body15:                                       ; preds = %for.cond12
  ...
  %arrayidx20 = getelementptr inbounds [81 x [81 x i8]], [81 x [81 x i8]]* %r, i64 0, i64 %idxprom19
  ...
  %arrayidx24 = getelementptr inbounds [81 x [81 x i8]], [81 x [81 x i8]]* %r, i64 0, i64 %idxprom23
...
if.then:                                          ; preds = %for.body39
  ...
  %arrayidx46 = getelementptr inbounds [81 x [81 x i8]], [81 x [81 x i8]]* %r, i64 0, i64 %idxprom45
  ...
  %arrayidx52 = getelementptr inbounds [81 x [81 x i8]], [81 x [81 x i8]]* %s, i64 0, i64 %idxprom51
  ...
  %arrayidx61 = getelementptr inbounds [81 x [81 x i8]], [81 x [81 x i8]]* %r, i64 0, i64 %idxprom60
  ...
  %arrayidx66 = getelementptr inbounds [81 x [81 x i8]], [81 x [81 x i8]]* %p0, i64 0, i64 %idxprom65
  ...
  %arrayidx72 = getelementptr inbounds [81 x [81 x i8]], [81 x [81 x i8]]* %s, i64 0, i64 %idxprom71
  ...
  %arrayidx77 = getelementptr inbounds [81 x [81 x i8]], [81 x [81 x i8]]* %p1, i64 0, i64 %idxprom76
  ...
  %arrayidx81 = getelementptr inbounds [81 x [81 x i8]], [81 x [81 x i8]]* %p0, i64 0, i64 %idxprom80
  ...
  %arrayidx86 = getelementptr inbounds [81 x [81 x i8]], [81 x [81 x i8]]* %p1, i64 0, i64 %idxprom85
  ...
  %arrayidx93 = getelementptr inbounds [81 x [81 x i8]], [81 x [81 x i8]]* %z, i64 0, i64 %idxprom92
...
if.then121:                                       ; preds = %for.body118
  ...
  %arrayidx123 = getelementptr inbounds [81 x [81 x i8]], [81 x [81 x i8]]* %z, i64 0, i64 %idxprom122
