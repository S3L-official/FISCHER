...
if.then:                                          ; preds = %for.body61
  ...
  %arrayidx65 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* %r, i64 0, i64 %idxprom64
...
for.cond.i.i109:                                  ; preds = %for.body.i.i118, %for.end79
  ...
  %cmp.i.i108 = icmp sle i32 %70, 100
