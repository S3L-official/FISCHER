...
for.end21:                                        ; preds = %for.cond
  ...
  %arrayidx22 = getelementptr inbounds [6 x [3 x i8]], [6 x [3 x i8]]* %cc, i64 0, i64 1
  %arraydecay = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx22, i64 0, i64 0
...
for.body27:                                       ; preds = %for.cond24
  ...
  %arrayidx29 = getelementptr inbounds [6 x [3 x i8]], [6 x [3 x i8]]* %cc, i64 0, i64 %idxprom28
  %arraydecay30 = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx29, i64 0, i64 0
...
for.body.i139:                                    ; preds = %for.cond.i127
  ...
  %rem2.i133 = srem i32 %add1.i132, 3
...
vmult.exit141:                                    ; preds = %for.cond.i127
  ...
  %arrayidx33 = getelementptr inbounds [6 x [3 x i8]], [6 x [3 x i8]]* %cc, i64 0, i64 %idxprom32
  %arraydecay34 = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx33, i64 0, i64 0
...
for.body.i161:                                    ; preds = %for.cond.i149
  ...
  %rem2.i155 = srem i32 %add1.i154, 3
...
for.end37:                                        ; preds = %for.cond24
  %arrayidx38 = getelementptr inbounds [6 x [3 x i8]], [6 x [3 x i8]]* %cc, i64 0, i64 1
  %arraydecay39 = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx38, i64 0, i64 0
  %arrayidx40 = getelementptr inbounds [3 x [3 x i8]], [3 x [3 x i8]]* %r, i64 0, i64 1
  %arraydecay41 = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx40, i64 0, i64 0
  %arrayidx42 = getelementptr inbounds [6 x [3 x i8]], [6 x [3 x i8]]* %dd, i64 0, i64 1
...
for.body.i180:                                    ; preds = %for.cond.i171
  ...
  %rem2.i177 = srem i32 %add1.i176, 3
...
for.body48:                                       ; preds = %for.cond45
  ...
  %arrayidx51 = getelementptr inbounds [6 x [3 x i8]], [6 x [3 x i8]]* %dd, i64 0, i64 %idxprom50
  %arraydecay52 = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx51, i64 0, i64 0
  %90 = load i32, i32* %i44, align 4
  %mul53 = mul nsw i32 2, %90
  %idxprom54 = sext i32 %mul53 to i64
  %arrayidx55 = getelementptr inbounds [6 x [3 x i8]], [6 x [3 x i8]]* %cc, i64 0, i64 %idxprom54
  %arraydecay56 = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx55, i64 0, i64 0
  %91 = load i32, i32* %i44, align 4
  %mul57 = mul nsw i32 3, %91
  %sub58 = sub nsw i32 %mul57, 1
  %idxprom59 = sext i32 %sub58 to i64
  %arrayidx60 = getelementptr inbounds [6 x [3 x i8]], [6 x [3 x i8]]* %dd, i64 0, i64 %idxprom59
  %arraydecay61 = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx60, i64 0, i64 0
...
for.body.i221:                                    ; preds = %for.cond.i206
  ...
  %rem2.i213 = srem i32 %add1.i212, 3
...
vadd.exit223:                                     ; preds = %for.cond.i206
  ...
  %arrayidx65 = getelementptr inbounds [6 x [3 x i8]], [6 x [3 x i8]]* %dd, i64 0, i64 %idxprom64
  %arraydecay66 = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx65, i64 0, i64 0
  %105 = load i32, i32* %i44, align 4
  %mul67 = mul nsw i32 2, %105
  %add68 = add nsw i32 %mul67, 1
  %idxprom69 = sext i32 %add68 to i64
  %arrayidx70 = getelementptr inbounds [6 x [3 x i8]], [6 x [3 x i8]]* %cc, i64 0, i64 %idxprom69
  %arraydecay71 = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx70, i64 0, i64 0
  %106 = load i32, i32* %i44, align 4
  %mul72 = mul nsw i32 3, %106
  %idxprom73 = sext i32 %mul72 to i64
  %arrayidx74 = getelementptr inbounds [6 x [3 x i8]], [6 x [3 x i8]]* %dd, i64 0, i64 %idxprom73
  %arraydecay75 = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx74, i64 0, i64 0
...
for.body.i254:                                    ; preds = %for.cond.i239
  ...
  %rem2.i246 = srem i32 %add1.i245, 3
...
vadd.exit256:                                     ; preds = %for.cond.i239
  ...
  %arrayidx78 = getelementptr inbounds [6 x [3 x i8]], [6 x [3 x i8]]* %dd, i64 0, i64 %idxprom77
  %arraydecay79 = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx78, i64 0, i64 0
...
ceil_.exit:                                       ; preds = %if.then.i, %if.end.i
  ...
  %arrayidx84 = getelementptr inbounds [3 x [3 x i8]], [3 x [3 x i8]]* %r, i64 0, i64 %idxprom83
  ...
  %arrayidx89 = getelementptr inbounds [6 x [3 x i8]], [6 x [3 x i8]]* %dd, i64 0, i64 %idxprom88
  %arraydecay90 = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx89, i64 0, i64 0
...
for.body.i279:                                    ; preds = %for.cond.i264
  ...
  %rem2.i271 = srem i32 %add1.i270, 3
...
for.end93:                                        ; preds = %for.cond45
  %arrayidx94 = getelementptr inbounds [6 x [3 x i8]], [6 x [3 x i8]]* %dd, i64 0, i64 4
  %arraydecay95 = getelementptr inbounds [3 x i8], [3 x i8]* %arrayidx94, i64 0, i64 0
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [3 x i8], [3 x i8]* %r, i64 0, i64 %idxprom
...
for.end:                                          ; preds = %for.cond
  %arraydecay = getelementptr inbounds [3 x i8], [3 x i8]* %r, i64 0, i64 0
