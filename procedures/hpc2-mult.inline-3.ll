...
if.then:                                          ; preds = %for.body39
  ...
  %arrayidx47 = getelementptr inbounds [4 x [4 x i8]], [4 x [4 x i8]]* %r, i64 0, i64 %idxprom46
  ...
  %arrayidx52 = getelementptr inbounds [4 x [4 x i8]], [4 x [4 x i8]]* %u, i64 0, i64 %idxprom51
  ...
  %arrayidx59 = getelementptr inbounds [4 x [4 x i8]], [4 x [4 x i8]]* %r, i64 0, i64 %idxprom58
  %50 = load i32, i32* %j35, align 4
  %idxprom60 = sext i32 %50 to i64
  %arrayidx61 = getelementptr inbounds [4 x i8], [4 x i8]* %arrayidx59, i64 0, i64 %idxprom60
  ...
  %arrayidx66 = getelementptr inbounds [4 x [4 x i8]], [4 x [4 x i8]]* %v, i64 0, i64 %idxprom65
...
if.then94:                                        ; preds = %for.body91
  ...
  %arrayidx96 = getelementptr inbounds [4 x [4 x i8]], [4 x [4 x i8]]* %u, i64 0, i64 %idxprom95
  ...
  %arrayidx103 = getelementptr inbounds [4 x [4 x i8]], [4 x [4 x i8]]* %v, i64 0, i64 %idxprom102
