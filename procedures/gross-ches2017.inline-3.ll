...
for.body26:                                       ; preds = %for.cond23
  ...
  %arraydecay = getelementptr inbounds [4 x i8], [4 x i8]* %ab1, i64 0, i64 0
...
vmult.exit104:                                    ; preds = %for.cond.i90
  ...
  %arraydecay29 = getelementptr inbounds [4 x i8], [4 x i8]* %a1b, i64 0, i64 0
...
for.body.i124:                                    ; preds = %for.cond.i112
  ...
  %rem2.i118 = srem i32 %add1.i117, 4
...
vmult.exit126:                                    ; preds = %for.cond.i112
  ...
  %arraydecay32 = getelementptr inbounds [4 x i8], [4 x i8]* %ab2, i64 0, i64 0
...
for.body.i146:                                    ; preds = %for.cond.i134
  ...
  %rem2.i140 = srem i32 %add1.i139, 4
...
vmult.exit148:                                    ; preds = %for.cond.i134
  ...
  %arraydecay35 = getelementptr inbounds [4 x i8], [4 x i8]* %a2b, i64 0, i64 0
...
for.body.i168:                                    ; preds = %for.cond.i156
  ...
  %rem2.i162 = srem i32 %add1.i161, 4
...
vmult.exit170:                                    ; preds = %for.cond.i156
  ...
  %arrayidx37 = getelementptr inbounds [4 x [4 x i8]], [4 x [4 x i8]]* %r, i64 0, i64 %idxprom36
  %arraydecay38 = getelementptr inbounds [4 x i8], [4 x i8]* %arrayidx37, i64 0, i64 0
...
for.body.i187:                                    ; preds = %for.cond.i178
  ...
  %rem2.i184 = srem i32 %add1.i183, 4
...
vadd.exit:                                        ; preds = %for.cond.i178
  ...
  %arraydecay39 = getelementptr inbounds [4 x i8], [4 x i8]* %ab1, i64 0, i64 0
...
for.body.i228:                                    ; preds = %for.cond.i213
  ...
  %rem2.i220 = srem i32 %add1.i219, 4
...
vadd.exit230:                                     ; preds = %for.cond.i213
  ...
  %arraydecay40 = getelementptr inbounds [4 x i8], [4 x i8]* %a1b, i64 0, i64 0
...
for.body.i400:                                    ; preds = %for.cond.i385
  ...
  %rem2.i392 = srem i32 %add1.i391, 4
...
vadd.exit402:                                     ; preds = %for.cond.i385
  ...
  %arrayidx42 = getelementptr inbounds [4 x [4 x i8]], [4 x [4 x i8]]* %r, i64 0, i64 %idxprom41
...
for.body.i447:                                    ; preds = %for.cond.i432
  ...
  %rem2.i439 = srem i32 %add1.i438, 4
...
vadd.exit449:                                     ; preds = %for.cond.i432
  ...
  %arraydecay44 = getelementptr inbounds [4 x i8], [4 x i8]* %ab2, i64 0, i64 0
...
for.body.i494:                                    ; preds = %for.cond.i479
  ...
  %rem2.i486 = srem i32 %add1.i485, 4
...
vadd.exit496:                                     ; preds = %for.cond.i479
  ...
  %arraydecay45 = getelementptr inbounds [4 x i8], [4 x i8]* %a2b, i64 0, i64 0
...
for.body.i519:                                    ; preds = %for.cond.i504
  ...
  %rem2.i511 = srem i32 %add1.i510, 4
...
for.body.i469:                                    ; preds = %for.cond.i457
  ...
  %rem2.i463 = srem i32 %add1.i462, 4
...
vmult.exit471:                                    ; preds = %for.cond.i457
  ...
  %arraydecay50 = getelementptr inbounds [4 x i8], [4 x i8]* %a1b, i64 0, i64 0
  store i8* %205, i8** %a.addr.i403, align 8
  store i32 1, i32* %ra.addr.i404, align 4
...
for.body.i422:                                    ; preds = %for.cond.i410
  ...
  %rem2.i416 = srem i32 %add1.i415, 4
...
for.body.i375:                                    ; preds = %for.cond.i363
  ...
  %rem2.i369 = srem i32 %add1.i368, 4
...
vmult.exit377:                                    ; preds = %for.cond.i363
  ...
  %arrayidx52 = getelementptr inbounds [4 x [4 x i8]], [4 x [4 x i8]]* %r, i64 0, i64 0
  %arraydecay53 = getelementptr inbounds [4 x i8], [4 x i8]* %arrayidx52, i64 0, i64 0
...
for.body.i353:                                    ; preds = %for.cond.i338
  ...
  %rem2.i345 = srem i32 %add1.i344, 4
...
vadd.exit355:                                     ; preds = %for.cond.i338
  ...
  %arraydecay54 = getelementptr inbounds [4 x i8], [4 x i8]* %ab1, i64 0, i64 0
...
for.body.i328:                                    ; preds = %for.cond.i313
  ...
  %rem2.i320 = srem i32 %add1.i319, 4
...
vadd.exit330:                                     ; preds = %for.cond.i313
  ...
  %arraydecay55 = getelementptr inbounds [4 x i8], [4 x i8]* %a1b, i64 0, i64 0
...
for.body.i303:                                    ; preds = %for.cond.i288
  ...
  %rem2.i295 = srem i32 %add1.i294, 4
...
for.body.i278:                                    ; preds = %for.cond.i263
  ...
  %rem2.i270 = srem i32 %add1.i269, 4
...
vadd.exit280:                                     ; preds = %for.cond.i263
  ...
  %arraydecay58 = getelementptr inbounds [4 x i8], [4 x i8]* %ab2, i64 0, i64 0
...
for.body.i253:                                    ; preds = %for.cond.i238
  ...
  %rem2.i245 = srem i32 %add1.i244, 4
